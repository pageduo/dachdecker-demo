...
export default async function LoginPage({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate px-5">
      <div className="w-full max-w-sm rounded-3xl bg-slate-light p-8 text-center sm:p-10">
        ...
        {message && (
          <p className="mt-5 rounded-xl bg-ink/40 px-4 py-3 text-sm text-copper-light">{message}</p>
        )}

        <a
          href={startUrl}
          className="mt-8 flex items-center justify-center gap-3 rounded-full bg-copper px-6 py-3.5 text-sm font-semibold text-paper transition hover:bg-copper-light"
        >
