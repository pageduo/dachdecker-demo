...
export const metadata: Metadata = {
  title: "Datenschutzerklärung (Platzhalter) | TRAVEDACH Demo",
};
    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8">
        <div className="flex flex-col gap-10 text-sm leading-relaxed text-stone">
          <section>
            <h2 className="mb-3 font-display text-xl font-medium text-ink">1. Verantwortlicher</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-xl font-medium text-ink">3. Schriftarten</h2>
            <p>
              Die verwendeten Schriftarten (Fraunces, Inter) werden über <code>next/font</code>{" "}
              lokal ausgeliefert. Es findet keine Verbindung zu Google-Servern statt, es werden
          ...
          <section>
            <h2 className="mb-3 font-display text-xl font-medium text-ink">5. Google Maps</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-xl font-medium text-ink">6. Kontaktformular</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 font-display text-xl font-medium text-ink">7. Ihre Rechte</h2>
            <p>
