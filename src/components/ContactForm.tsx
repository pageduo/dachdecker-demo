    ...
    <form onSubmit={onSubmit} className="flex flex-col gap-4 rounded-3xl bg-slate p-8 sm:p-10">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <input
          ...
          type="text"
          placeholder="Name"
          className="rounded-xl border border-paper/15 bg-transparent px-4 py-3 text-sm text-paper placeholder:text-paper/40 focus:border-copper focus:outline-none"
        />
        <input
          required
          type="email"
      ...
      <textarea
        required
        placeholder="Ihre Nachricht (z. B. Art des Schadens, Dachgröße, Zeitrahmen)"
        rows={4}
        className="resize-none rounded-xl border border-paper/15 bg-transparent px-4 py-3 text-sm text-paper placeholder:text-paper/40 focus:border-copper focus:outline-none"
      />
      <label className="flex items-start gap-3 text-xs leading-relaxed text-paper/60">
        <input required type="checkbox" className="mt-0.5 h-4 w-4 accent-copper" />
        <span>
          Ich habe die{" "}
      ...
      <button
        type="submit"
        className="mt-2 rounded-full bg-copper px-6 py-3.5 text-sm font-semibold text-paper transition hover:bg-copper-light"
      >
        Nachricht senden
      </button>
