...
export default function LegalHero({ eyebrow, title }: { eyebrow: string; title: string }) {
  return (
    <div className="bg-slate pb-16 pt-32 sm:pt-40">
      <div className="mx-auto max-w-3xl px-5 sm:px-8">
        <p className="eyebrow text-copper-light">{eyebrow}</p>
        <h1 className="mt-4 font-display text-3xl font-medium text-paper sm:text-5xl">{title}</h1>
        <div className="mt-6 rounded-2xl border border-copper-light/30 bg-copper/10 px-5 py-4 text-sm leading-relaxed text-paper/80">
