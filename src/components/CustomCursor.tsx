      ...
      <AnimatePresence>
        {label && (
          <motion.div
            ...
            className="flex h-24 w-24 items-center justify-center rounded-full bg-copper text-center font-display text-xs font-semibold uppercase tracking-wide text-paper shadow-lg"
          >
            {label}
          </motion.div>
        )}
